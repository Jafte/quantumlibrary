...
class Story(models.Model):
    ...
    authors = models.ManyToManyField(User, verbose_name=_('Authors'), related_name="stories", blank=True, null=True)
    ...
    anotation = models.TextField(verbose_name=_('Anotation'))
...
class StoryPart(MPTTModel):
    story = models.ForeignKey(Story, verbose_name=_('Story part'), related_name="+")
